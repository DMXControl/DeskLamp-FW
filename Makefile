...
AVRDUDE_WRITE_FUSES = -U lfuse:w:ee:m -U hfuse:w:df:m -U efuse:w:ff:m
...
AVRDUDE_BASIC = -p t84 -c $(AVRDUDE_PROGRAMMER)
...
.elf.hex:
	$(OBJCOPY) -O $(FORMAT) -R .eeprom -R .signature -R .fuse -R .lock $< $@
