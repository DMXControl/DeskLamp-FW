...
#define  USB_CFG_VENDOR_ID       0xD0, 0x16 /* 5840 dec */
/* USB vendor ID for the device, low byte first. If you have registered your
 * own Vendor ID, define it here. Otherwise you use obdev's free shared
 * VID/PID pair. Be sure to read USBID-License.txt for rules!
 */
#define  USB_CFG_DEVICE_ID       0x31, 0x08 /* 2097 dec */
 ...
 */
#define USB_CFG_VENDOR_NAME     'w', 'w', 'w', '.', 'd', 'm', 'x', 'c', 'o', 'n', 't', 'r', 'o', 'l', '.', 'd', 'e'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D', 'e', 's', 'k', 'L', 'a', 'm', 'p'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    146  /* total length of report descriptor */
